...
for prefix in STAGING PRODUCTION; do for suffix in S3_PUBLIC_BUCKET S3_PRIVATE_BUCKET S3_ACCESS_KEY S3_SECRET_KEY S3_BACKUP_READER_ACCESS_KEY S3_BACKUP_READER_SECRET_KEY S3_PROVISIONING_ACCESS_KEY S3_PROVISIONING_SECRET_KEY BACKUP_S3_BUCKET BACKUP_S3_ACCESS_KEY BACKUP_S3_SECRET_KEY; do key="${prefix}_${suffix}"; vault_kv "$VAULT_FILE" "$key" "${!key}"; done; done
